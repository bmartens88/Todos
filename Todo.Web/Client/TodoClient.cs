...
public sealed class TodoClient
{
    ...
    public async Task<bool> LoginAsync(string? username, string? password)
    {
        ...
        var response =
            await _client.PostAsJsonAsync("auth/login", new UserInfo { Password = password, Username = username });
        return response.IsSuccessStatusCode;
    }
    ...
    public async Task<bool> CreateUserAsync(string? username, string? password)
    {
        ...
        var response =
            await _client.PostAsJsonAsync("auth/register", new UserInfo { Username = username, Password = password });
        return response.IsSuccessStatusCode;
    }
